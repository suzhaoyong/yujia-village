<template>
  <div class="warp" style>
    <van-nav-bar title="商品" left-arrow @click-left="back">
      <van-icon name="share" slot="right" @click="handleShareGoods" />
    </van-nav-bar>
  ...
  methods: {
    ...
    handleShareGoods() {
      ...
      const params = {
        ...
        identity: "good",
        userId: this.isUserNeedLogin
          ? ""
          : (this.info.user && this.info.user.id) || "",
