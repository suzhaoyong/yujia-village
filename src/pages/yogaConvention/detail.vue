      ...
      <el-col :span="24">
        <div class="detail-main">
          ...
          <div class="navs">
                ...
                <el-breadcrumb-item :to="{ path: '/yogaConvention/index' }">瑜伽大会</el-breadcrumb-item>
                <el-breadcrumb-item>{{train.theme}}</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
          <div class="detail-count-div2">
            <!-- <div  v-if="train.path && train.path.length > 0" :class="`${train.path && train.path.length > 0 ? 'count-div2-img scorll' : 'count-div2-img'}`" style="cursor: pointer;">
              <img
                @click="changeTrainImage()"
                class="img1"
                :src="train.path"
              />
            </div> -->
            <div class="count-div2-imgpic">
              <img class="img1" :src="train.path" :alt="train.theme"/>
            </div>
            <div class="count-div2-text">
              ...
              <div class="kecheng_box">
                <div class="kecheng_lf">
                  ...
                  <span class="kecheng_title" style="font-size: 0.7rem;font-weight: bolder;">联系人：</span>
                  <div class="kecheng_value"  style="font-size: 0.7rem;font-weight: bolder;">{{train.linkman}}</div>
                  </div>
                  <div class="kecheng_item">
                  <span class="kecheng_title" style="font-size: 0.7rem;font-weight: bolder;">联系人电话：</span>
                  <div class="kecheng_value"  style="font-size: 0.7rem;font-weight: bolder;">{{train.tel}}</div>
                  </div>
                </div>
              ...
              <div class="cultivate-text2">培训地址：{{train.auto_address}}</div>
...
<script>
import { getTrains, postTrains, getTrainsById } from "@/api/convention";
...
export default {
  ...
  methods: {
    buyTrain() {
      ...
      const { id } = this.$route.params;
      this.$router.push(`/yogaConvention/order/${id}`)
    },
    ...
    initSocialConfig() {
      const { theme, intro, content, path, crowd } = this.train;
      const params = {
        url: `http://www.yujiacun.net/yogaConvention/detail/${this.$route.params.id}`,
        title: theme,
