                ...
                <div class="cultivate-main">
                    ...
                    <div class="cultivate-count">
                            ...
                            <div class="cultivate1">
                                ...
                                <div class="cultivate1-two">
                                    ...
                                    <div class="button-price">
                                        <el-button type="text" :class="{active3 : active3 == item.name}" v-for="item in priceList" :key="item.name" @click="selected3(item.name)">{{item.name}}</el-button>
                                        <el-input v-model="input" placeholder="请输入金额" class="price-input1"></el-input> — <el-input v-model="input2" placeholder="请输入金额" class="price-input2"></el-input>
                                    </div>
                                </div>
                                ...
                                <div class="cultivate1-four">
                                    ...
                                    <div class="button-text">
                                        <el-button type="text" :class="{active : active == item.name}" v-for="item in wpList" :key="item.name" @click="selected(item.name)">{{item.name}}</el-button>
                                    </div>
                                </div>
                                <div class="cultivate1-five">
                                    ...
                                    <div class="button-classfiy">
                                        <el-button type="text" :class="{active2 : active2 == item.name}" v-for="item in classfiy" :key="item.name" @click="selected2(item.name)">{{item.name}}</el-button>
                                    </div>
                                </div>
                                <div class="cultivate1-six">
                                    <span class="span">已选：</span>
                                    <el-tag v-for="tag in tags" :key="tag.name" closable :type="tag.type" class="tag">{{tag.name}}</el-tag>
                                </div>
                            </div>
                        ...
                        <div class="cultivate-count-div3">
                            <div class="fruit-list-li" v-for="(item,index) in fruitclasslist" :key="index" @click="selectItem(item)">
                                <div class="fruit-list-li-img">
                                    <img :src="item.img"/>
                                </div>
                                <div class="fruit-list-li-text">
                        ...
                        <div class="cultivate-count-div4">
                            <h2><img src="../../assets/yujia.png"/>最新发布</h2>
                            <p class="nav-text">Sometimes beauty is so simple</p>
                            <div class="border-left"></div>
                            <div class="border-right"></div>
                        </div>
        ...
        .cultivate-count-div1{
            ...
            .fruit-list{
                ...
                .fruit-list-li{
                    ...
                    height: 35.6rem;
                    background-color: #ffffff;
                    box-shadow: 0.1rem 0.2rem 1.3rem 0.1rem 
                        rgba(164, 164, 164, 0.39);
                    border-radius: 0.3rem;
                    float: left;
                    margin-left: 1.4rem;
                    margin-top: 2rem;
