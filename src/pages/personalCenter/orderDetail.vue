    ...
    <div class="order-box">
      <div class="navs">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item :to="{ path: '/personal/recode' }">订单中心</el-breadcrumb-item>
          <el-breadcrumb-item>订单详情</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="order">
        <session-title name="订单详情" brief="The customer's excellent experience is our goal from beginning to end." :line="false"></session-title>
            ...
            <div class="body">
              ...
              <div class="personal" v-if="getAddress">
                ...
                <div class="personal_right" v-show="false">
                  <div class="edit" @click="changeAddress">修改地址</div>
                </div>
              </div>
              <div class="deliviery" style="align-items: center;">
                ...
                <span><strong>订单状态：{{detail.status}}</strong></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="payment_mode" v-show="false">
        ...
        <div class="Integraluse">
          <div class="Integraluse_bottom">
            ...
            <div class="use_six">
              ...
              <span class="span_uses">{{(getAllSelectNumberAndPrice.allPrice - detail.totalPrice).toFixed(2)}}元</span>
            </div>
          </div>
        </div>
        <div class="sum">
          ...
          <div class="count" v-if="detail.status === '待付款'">
...
export default {
  ...
  methods: {
    ...
    payOrder() {
      const { payment, out_trade_no, totalPrice } = this.detail
      if( payment === '支付宝') {
      ...
      if( payment === '微信') {
        sessionStorage.setItem('total_fee', totalPrice)
        this.$router.push({
          name: 'wechat pay',
          query: {
